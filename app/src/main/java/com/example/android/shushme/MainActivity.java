...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TOD (9) Create a boolean SharedPreference to store the state of the "Enable Geofences" switch
        ...
        // TOD (10) Handle the switch's change event and Register/Unregister geofences based on the value of isChecked
