...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // TOD (5) Call getGeofenceTransition to get the transition type and use AudioManager to set the
        ...
        if (geoFencingTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            Log.e(TAG, String.format("Where TF are you ? : %d", geoFencingTransition));
            return;

        }
        sendNotification(context, geoFencingTransition);

        // TOD (6) Show a notification to alert the user that the ringer mode has changed.
